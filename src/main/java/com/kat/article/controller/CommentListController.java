...
import com.kat.article.service.CommentListService;
...
public class CommentListController {
	...
	public ModelAndView commentListSubmit(@RequestParam(name = "page", defaultValue = "1")int pageNumber, @RequestParam(name = "go_with_no") int go_with_no, HttpServletRequest request)throws IllegalStateException,IOException{
...
System.out.println("[CommentListController commentListSubmit] go_with_no :" +go_with_no);
		CommentInfoListView commentInfoListView = commentListService.sendCommentList(pageNumber, go_with_no);
