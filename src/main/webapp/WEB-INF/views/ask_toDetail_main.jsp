...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/asklistInfo.css">
</head>

<body>
	<jsp:include page="/WEB-INF/views/kat_main/katHeader.jsp" flush="false"></jsp:include>
	<jsp:include page="/WEB-INF/views/kat_customer/ListInfo.jsp" flush="false"></jsp:include>
