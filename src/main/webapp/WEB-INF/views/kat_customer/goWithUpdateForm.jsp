...
<div class="totalView">
<div class="gowith_main_update_title"><span>동행 게시판 수정</span></div>
<div class="mainSize">
     <form method="post"
			action="<%=request.getContextPath()%>/kat/gowith/updateInfo.do?no=${ListInfoUpdateGo_with.go_with_no}">
        <table>
           <tr>
        ...
        <input type="submit" name="go_with" class="go_with_update_btn" value="작성완료" />
     </form>
</div>
</div>
