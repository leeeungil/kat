...
<body>
   ...
   <jsp:include page="/WEB-INF/views/kat_customer/view.jsp" flush="false"></jsp:include>
   <jsp:include page="/WEB-INF/views/kat_customer/replyList.jsp" flush="false"></jsp:include>
</body>