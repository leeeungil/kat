...
<link type="text/css" rel="stylesheet" href="<%=request.getContextPath()%>/css/askWriteForm.css">
</head>

<body>
	<jsp:include page="/WEB-INF/views/kat_main/katHeader.jsp" flush="false"></jsp:include>
	<jsp:include page="/WEB-INF/views/kat_customer/askWriteForm.jsp" flush="false"></jsp:include>
